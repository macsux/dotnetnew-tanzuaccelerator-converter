...
namespace TemplateEngine
{
    ...
    public partial class Template
    {
        ...
        /// <summary>
        /// A shorthand name for selecting the template (applies to environments where the template
        /// name is specified by the user - not selected via a GUI).
        /// </summary>
    ...
    public partial class PostAction
    {
        ...
        public List<ManualInstruction> ManualInstructions { get; set; }
    }
    ...
    public partial class Generator
    {
        ...
        /// </summary>
        [JsonProperty("fileRename", NullValueHandling = NullValueHandling.Ignore)]
    ...
    public partial class ParametersClass
    {
        ...
        ///
        /// The symbol to search for a match. Its value will be used by this generator's regex to
        /// evaluate if there is a match. The value of the source parameter is not modified
        /// </summary>
        [JsonProperty("source", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// <summary>
        /// The value used as the separator between the values to be concatenated, notice that you
        /// can use "/" as folder separator also on Windows since File API will convert it into "\"
        /// </summary>
    ...
    {
        /// <summary>
        /// "ref" to reference value from another symbol or "const" for string constant, defaults to
        /// "const".
        /// </summary>
    ...
    public enum Datatype { Choice, Bool, Float, Int, Hex, Text  };

    public enum GeneratorEnum { Casing, Coalesce, Constant, Evaluate, Guid, Join, Now, Port, Random, Regex, RegexMatch, Switch };

    /// <summary>
    /// "ref" to reference value from another symbol or "const" for string constant, defaults to
    /// "const".
    /// </summary>
    public enum PurpleType { Const, Ref };
    ...
    /// Defines the high level configuration of symbol
    /// </summary>
    public enum FluffyType { Bind, Computed, Derived, Generated, Parameter };
    ...
    public partial struct Ice
    {
        ...
        public static implicit operator Ice(List<string> StringArray) => new Ice { StringArray = StringArray };
    }
    ...
    public partial struct ChoiceElement
    {
        ...
        public static implicit operator ChoiceElement(List<object> AnythingArray) => new ChoiceElement { AnythingArray = AnythingArray };
    ...
    public partial struct OnlyIfUnion
    {
        ...
        public static implicit operator OnlyIfUnion(List<object> AnythingArray) => new OnlyIfUnion { AnythingArray = AnythingArray };
    ...
    public partial struct StepElement
    {
        ...
        public static implicit operator StepElement(List<object> AnythingArray) => new StepElement { AnythingArray = AnythingArray };
    ...
    public partial struct ParametersUnion
    {
        ...
        public static implicit operator ParametersUnion(List<object> AnythingArray) => new ParametersUnion { AnythingArray = AnythingArray };
    ...
    public partial class Template
    {
        public static Template FromJson(string json) => JsonConvert.DeserializeObject<Template>(json, TemplateEngine.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Template self) => JsonConvert.SerializeObject(self, TemplateEngine.Converter.Settings);
    }
    ...
    internal class GeneratorEnumConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case "regexMatch":
                    return GeneratorEnum.RegexMatch;
                case "switch":
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case GeneratorEnum.Regex:
                    ...
                    return;
                case GeneratorEnum.RegexMatch:
                    serializer.Serialize(writer, "regexMatch");
                    return;
    ...
    internal class PurpleTypeConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "const":
                    return PurpleType.Const;
                case "ref":
                    return PurpleType.Ref;
            }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                case PurpleType.Const:
                    serializer.Serialize(writer, "const");
                    return;
                case PurpleType.Ref:
    ...
    internal class FluffyTypeConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "bind":
                    return FluffyType.Bind;
                case "computed":
                    return FluffyType.Computed;
                case "derived":
                    return FluffyType.Derived;
                case "generated":
                    return FluffyType.Generated;
                case "parameter":
                    return FluffyType.Parameter;
            }
